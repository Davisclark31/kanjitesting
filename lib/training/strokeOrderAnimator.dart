...
import 'package:kanjiapp/training/strokeOrderAnimationController.dart';
        ...
        children: <Widget>[
          ...List.generate(widget._controller.strokes.length, (index) {
            ...
            if (widget._controller.isQuizzing &&
              ...
              strokeColor = widget._controller.testhintColor;
            }
            ...
            final animationController = widget._controller.isQuizzing
                ? widget._controller.testhintAnimationController

...
import 'package:kanjiapp/training/strokeOrderAnimator.dart';
...
class StrokeOrderAnimationController extends ChangeNotifier {
  ...
  AnimationController _testhintAnimationController;
  AnimationController get testhintAnimationController =>
      _testhintAnimationController;
  ...
  double _testhintAnimationSpeed = 3;
  ...
  Color get testhintColor => _testhintColor;
  ...
  int _testhintAfterStrokes;
  int get testhintAfterStrokes => _testhintAfterStrokes;
  ...
  StrokeOrderAnimationController(
    ...
    double testhintAnimationSpeed: 3,
    ...
    int testhintAfterStrokes: 3,
    Color hintColor: Colors.lightBlueAccent,
    Color testhintColor: Colors.lightBlueAccent,
    ...
    Function? onCorrectStrokeCallback,
        ...
        _testhintAfterStrokes = testhintAfterStrokes,
        _hintColor = hintColor,
        _testhintColor = testhintColor,
        _strokeAnimationSpeed = strokeAnimationSpeed,
        _hintAnimationSpeed = hintAnimationSpeed,
        _testhintAnimationSpeed = testhintAnimationSpeed,
        ...
        _testhintAnimationController = AnimationController(
          vsync: tickerProvider,
        ) {
    ...
    _testhintAnimationController.addStatusListener((status) {
      if (status == AnimationStatus.completed) {
        _testhintAnimationController.reset();
      }
    });
  ...
  dispose() {
    ...
    _testhintAnimationController.dispose();
  ...
  void startBeginnerQuiz() {
    setStrokeAnimationSpeed(1);
    animateHint();
    notifyListeners();
  }
  ...
  void setTestHintColor(Color value) {
    _testhintColor = value;
    notifyListeners();
  }
  ...
  void setTestHintAfterStrokes(int value) {
    _testhintAfterStrokes = value;
    notifyListeners();
  }
  ...
  void setTestHintAnimationSpeed(double value) {
    _testhintAnimationSpeed = value;
    _setCurrentStroke(currentStroke);
  }
  ...
  void _setNormalizedTestHintAnimationSpeed(double normFactor) {
    _testhintAnimationController.duration = Duration(
        milliseconds: (normFactor / _testhintAnimationSpeed * 1000).toInt());
  }
  ...
  void animateTestHint() {
    if (!(debugSemanticsDisableAnimations ?? false)) {
      _testhintAnimationController.reset();
      _testhintAnimationController.forward();
    }
  }
  ...
  void _setCurrentStroke(int value) {
    ...
    if (currentStroke < nStrokes) {
      ...
      if (medianLength > 0) {
        ...
        _setNormalizedTestHintAnimationSpeed(normFactor);
      }
    }
